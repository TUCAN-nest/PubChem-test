...
def _produce_molfiles(
    ...
    print(f"{get_current_time()}: Done producing molfiles.")
...
def _consume_molfiles(
    ...
    print(f"{get_current_time()}: Process {process_id} done consuming molfiles.")
...
def run(
    ...
    print(f"{get_current_time()}: Starting producer process.")
    ...
    print(
        f"{get_current_time()}: Distributing consumer function over {number_of_consumer_processes} processes."
    )
    consumer_processes = [
    ...
    print(f"{get_current_time()}: Starting logging results.")
