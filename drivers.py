...
def invariance_driver(
    sdf_path: str, log_path: str, consumer: Callable, get_molfile_id: Callable
):
    with sqlite3.connect(log_path) as log_db:
        ...
        pipeline.run(
            sdf_path=sdf_path,
            log_db=log_db,
            consumer_function=partial(consumer, get_molfile_id=get_molfile_id),
